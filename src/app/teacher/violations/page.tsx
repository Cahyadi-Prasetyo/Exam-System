...
export default function ViolationsPage() {
    const [data] = useState<Violation[]>(mockViolations);
            ...
            cell: (row: Violation) => (
                <div className="flex items-center gap-2">
                    <Button
                        variant="outline"
                        size="sm"
                        onClick={() => alert(`Review violation: ${row.id}`)}
                    >
                        Tinjau
                    </Button>
                </div>
    ...
    return (
        <div className="p-8">
            {/* Header */}
            <div className="mb-8">
                <h1 className="text-3xl font-bold tracking-tight">Tinjauan Pelanggaran</h1>
