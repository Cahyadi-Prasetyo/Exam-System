...
import { ArrowLeft, Calendar, Clock, FileText, Save, Settings, Sparkles } from "lucide-react";
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div className="flex items-center gap-4">
                        <div>
                            ...
                            <p className="text-sm text-gray-500 mt-1">Atur informasi dasar dan jadwal ujian</p>
                        </div>
                    </div>
                </div>
