    ...
    return (
        <div className="p-4 sm:p-8">
            <div className="mb-8">
                ...
                <p className="text-muted-foreground">Ringkasan sistem secara keseluruhan</p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                ...
                <StatCard
                    ...
                    value={mockAdminStats.totalViolations}
                    icon={
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            className="h-6 w-6"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <StatCard
                    title="User Nonaktif"
                    value={mockAdminStats.inactiveUsers}
